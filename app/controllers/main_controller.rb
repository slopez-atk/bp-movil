class MainController < ApplicationController
  ...
  def create_trial
    ...
    pending_trial.dir_garante= trial["dir_garante"]
    ...
    pending_trial.sucursal= trial["sucursal"]
    pending_trial.oficial_credito= trial["oficial_credito"]
    pending_trial.parroquia= trial["parroquia"]
    pending_trial.sector= trial["sector"]
    pending_trial.telefono= trial["telefono"]
    pending_trial.tel_garante= trial["telf_garante"]
